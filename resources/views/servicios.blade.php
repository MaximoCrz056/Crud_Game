...
<head>
    ...
    <style>
        * {
        ...
        .bg-pink {
            background-color: #c34f62;
        }

        .bg-teal {
            background-color: #7045068f;
        }
    </style>
</head>
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <nav class="-mx-3 flex flex-1">
                        ...
                        <a href="{{ route('login') }}" class="rounded-md px-5 py-2 text-white ring-1 ring-transparent transition hover:text-black/70 focus:outline-none focus-visible:ring-[#FF2D20] dark:text-white dark:hover:text-white/80 dark:focus-visible:ring-white">
                            Iniciar Sesion
                        </a>

                        @if (Route::has('register'))

                        <a href="{{ route('register') }}" class="rounded-md px-5 py-2 text-white ring-1 ring-transparent transition hover:text-black/70 focus:outline-none focus-visible:ring-[#FF2D20] dark:text-white dark:hover:text-white/80 dark:focus-visible:ring-white">
                            Registrarse
                        </a>
                        @endif
                        @endauth
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-lg-3 mb-5">
                <div class="card bg-yellow">
                    ...
                    <div class="card-body layer">
                        <br>
                        <h5 class="card-title">Renta Futbolito</h5>
                        <p class="card-text">
                            7 pelotas $1.00 <br>
                            5 pelotas $1.00
                        </p>
